"use strict";
// Module 21
function deleciousCake(jim, dela, chinku) {
...
function tallestInArrray(numbers) {
...
smallNumber(3, 1, 9);
// Average of an array
function averageOfArray(iArray) {
    let sum = 0;
...
function secondMaxOfArray(inputA) {
...
function secondMaxOfArray2(input) {
    let largest = 0;
    let secondLargest = 0;
